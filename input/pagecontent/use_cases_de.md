> **For the english version please click [here](use_cases_en.html).**
...
[![manual-import](manual_import_de.drawio.png "manual-import"){: style="width: 100%"}](manual_import_de.drawio.png)
